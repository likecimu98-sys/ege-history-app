...
test('метка недели считается с понедельника', () => {
  ...
  // 2026-07-26 — воскресенье, неделя началась 20 июля.
  assert.equal(mondayStr(new Date(2026, 6, 26)), '2026-07-20');
  assert.equal(mondayStr(new Date(2026, 6, 20)), '2026-07-20');
  assert.equal(mondayStr(new Date(2026, 6, 21)), '2026-07-20');
});
